...
function generateGenreHtml() {
    ...
    for (i = 1; i < 4; i++) {
        ...
        <select id="genre${i}" name="genre${i}" class="form-control select-style">
            <option id="defaultValue${i}" value="none" selected="selected">-</option>
            <option id="firstOption${i}" value="28" class="select-normal">Action</option>
                            ...
                            <div class="card-header" id="headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-primary more-details-button" data-toggle="collapse" data-target="#collapse${i}"
                                            ...
                                            Click here for details <i class="fas fa-info-circle"></i>
                                        </button>
                                    </h5>
                                </div>
                            </div>
